...
/*
	1 Заменяем все RepoUserRole
	2 Заменяем все domain.UserRole
...
// Change
func NewRepoUserRole(db database.IDB) *RepoUserRole {
	return &RepoUserRole{
		db:        db,
...
func (r *RepoUserRole) scanEntityRow(row pgx.Row) (*domain.UserRole, error) {
	var entity domain.UserRole
...
func (r *RepoUserRole) Add(ctx context.Context, entity *domain.UserRole) (int64, error) {
	if entity == nil {
...
func (r *RepoUserRole) Update(ctx context.Context, id int64, entity *domain.UserRole) error {
	if id <= 0 {
...
func (r *RepoUserRole) UpdateBy(ctx context.Context, filterKey, filterValue string, entity *domain.UserRole) error {
	if entity == nil {
		return fmt.Errorf("%w: entity is nil", ErrInvalidInput)
	}
...
// Not Change
func (r *RepoUserRole) Get(ctx context.Context, id int64) (*domain.UserRole, error) {
	if id <= 0 {
...
func (r *RepoUserRole) GetBy(ctx context.Context, filterKey, filterValue string) (*domain.UserRole, error) {
	if err := r.validateColumn(filterKey); err != nil {
		return nil, err
	}
...
func (r *RepoUserRole) GetByInt(ctx context.Context, filterKey string, filterValue int64) (*domain.UserRole, error) {
	if err := r.validateColumn(filterKey); err != nil {
		return nil, err
	}
...
func (r *RepoUserRole) List(ctx context.Context, offset, limit int64) ([]domain.UserRole, error) {
	var queryEnd string
	if offset != 0 || limit != 0 {
...
func (r *RepoUserRole) ListBy(ctx context.Context, filterKey, filterValue string, offset, limit int64) ([]domain.UserRole, error) {
	var queryEnd string
	if offset != 0 || limit != 0 {
		queryEnd = fmt.Sprintf("ORDER BY id LIMIT %d OFFSET %d", limit, offset)
	}
...
func (r *RepoUserRole) Delete(ctx context.Context, id int64, soft bool) error {
	if id <= 0 {
		return fmt.Errorf("%w: invalid id %d", ErrInvalidInput, id)
	}
...
func (r *RepoUserRole) DeleteBy(ctx context.Context, filterKey, filterValue string, soft bool) error {
	if err := r.validateColumn(filterKey); err != nil {
		return err
	}
...
// Not Change Utils
func (r *RepoUserRole) getColumnsStr() string {
	if r.columnsStr == "" {
...
func (r *RepoUserRole) getColumnsStrUpdate() string {
...
func (r *RepoUserRole) getColumnsUpdateI() int {
...
func (r *RepoUserRole) getColumnsInput() string {
	if r.columnsInput == "" {
		var result []string
...
func (r *RepoUserRole) getColumnsMap() map[string]struct{} {
	if r.columnsMap == nil {
...
func (r *RepoUserRole) validateColumn(key string) error {
...
func (r *RepoUserRole) scanEntityRows(rows pgx.Rows) ([]domain.UserRole, error) {
	defer rows.Close()

	var entities []domain.UserRole
	for rows.Next() {
